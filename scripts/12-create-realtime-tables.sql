...
CREATE INDEX idx_stats_cache_lookup ON public.stats_cache(app_id, stat_type, updated_at DESC);
...
CREATE INDEX idx_realtime_events_recent ON public.realtime_events(created_at DESC);
CREATE INDEX idx_realtime_events_app ON public.realtime_events(app_id, created_at DESC);
